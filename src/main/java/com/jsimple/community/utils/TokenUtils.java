package com.jsimple.community.utils;
...
public class TokenUtils {
    //private static final String SECRET = "com.jsimple.community";
    ...
    public static ResultDTO verifyToken(String token) throws Exception {
        ...
        JWTVerifier jwtVerifier = JWT.require(Algorithm.HMAC256(SECRET)).withIssuer("JSimpleUser").build();
        try {
